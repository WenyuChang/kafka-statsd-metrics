...
- Install the jar in Kafka classpath, typically `./kafka_2.9.2-xxx/libs/`
...
```bash
    ...
    kafka.metrics.reporters=com.rubicon.kafka.KafkaStatsdMetricsReporter
...
- A JMX MBean named `kafka:type=com.rubicon.kafka.KafkaStatsdMetricsReporter` should also exist.
