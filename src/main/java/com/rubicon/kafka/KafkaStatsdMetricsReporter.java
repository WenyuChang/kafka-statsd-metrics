...
package com.rubicon.kafka;

import com.rubicon.metrics.Dimension;
import com.rubicon.metrics.ExcludeMetricPredicate;
import com.rubicon.metrics.StatsDReporter;
...
public class KafkaStatsdMetricsReporter implements KafkaStatsdMetricsReporterMBean, KafkaMetricsReporter {
  ...
  private void loadConfig(VerifiableProperties props) {
    ...
    printVMMetrics = props.getBoolean("external.kafka.statsd.jvm.enabled", false);
  }
